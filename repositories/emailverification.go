...
type EmailVerificationRepository interface {
	...
	UpdateUsedAt(verification *models.EmailVerification, time time.Time) error
}
...
func (r *emailVerification) UpdateUsedAt(verification *models.EmailVerification, time time.Time) error {
	err := r.db.Model(&verification).Update("used_at", time).Error
	return err
}
